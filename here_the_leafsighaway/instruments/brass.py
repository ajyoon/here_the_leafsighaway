...
class Brass(base_instrument.Instrument):
    ...
    def build_pitch_rules(self):
        ...
        e_pn_5 = nodes.NoteBehavior(name='skip down - e', direction=-1, interval_weights=[(2, 4), (3, 2)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_6 = nodes.NoteBehavior(name='big leap up - e', direction=1, interval_weights=[(3, 10), (6, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_7 = nodes.NoteBehavior(name='big leap down - e', direction=-1, interval_weights=[(3, 10), (6, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        ...
        h_pn_5 = nodes.NoteBehavior(name='skip down - h', direction=-1, interval_weights=[(2, 5), (3, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_6 = nodes.NoteBehavior(name='leap up - h', direction=1, interval_weights=[(3, 5), (6, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_7 = nodes.NoteBehavior(name='leap down - h', direction=-1, interval_weights=[(3, 5), (6, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        ...
        c_pn_3 = nodes.NoteBehavior(name='step down - c', direction=-1, interval_weights=[(1, 4), (2, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_4 = nodes.NoteBehavior(name='skip up - c', direction=1, interval_weights=[(2, 5), (4, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_5 = nodes.NoteBehavior(name='skip down - c', direction=-1, interval_weights=[(2, 5), (4, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_6 = nodes.NoteBehavior(name='leap up - c', direction=1, interval_weights=[(4, 6), (7, 1)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_7 = nodes.NoteBehavior(name='leap down - c', direction=-1, interval_weights=[(4, 6), (7, 1)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
