...
class Instrument:
    ...
    def __init__(self, instrument_name='Flute', lowest_note=0, highest_note=36,
        ...
        self.note_array = note.NoteArray(initial_clef=self.initial_clef, transposition_int=self.transposition_int)
        ...
        self.artificial_harmonic_frequency = round(rand.weighted_rand(
    ...
    def build_pitch_rules(self):
        ...
        e_pn_1 = nodes.NoteBehavior(name='stay put - e', direction=0, interval_weights=[(0, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_2 = nodes.NoteBehavior(name='step up - e', direction=1, interval_weights=[(1, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_3 = nodes.NoteBehavior(name='step down - e', direction=-1, interval_weights=[(1, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_4 = nodes.NoteBehavior(name='skip up - e', direction=1, interval_weights=[(2, 4), (3, 2)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_5 = nodes.NoteBehavior(name='skip down - e', direction=-1, interval_weights=[(2, 4), (3, 2)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_6 = nodes.NoteBehavior(name='big leap up - e', direction=1, interval_weights=[(4, 10), (8, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        e_pn_7 = nodes.NoteBehavior(name='big leap down - e', direction=-1, interval_weights=[(4, 10), (8, 1)],
                                                                 pitch_set=e_f_b_pitch_set, count_intervals_by_slots=True)
        ...
        h_pn_1 = nodes.NoteBehavior(name='stay put - h', direction=0, interval_weights=[(0, 1)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_2 = nodes.NoteBehavior(name='step up - h', direction=1, interval_weights=[(1, 1)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_3 = nodes.NoteBehavior(name='step down - h', direction=-1, interval_weights=[(1, 1)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_4 = nodes.NoteBehavior(name='skip up - h', direction=1, interval_weights=[(2, 5), (3, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_5 = nodes.NoteBehavior(name='skip down - h', direction=-1, interval_weights=[(2, 5), (3, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_6 = nodes.NoteBehavior(name='leap up - h', direction=1, interval_weights=[(4, 5), (9, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        h_pn_7 = nodes.NoteBehavior(name='leap down - h', direction=-1, interval_weights=[(4, 5), (9, 2)],
                                                                 pitch_set=h_pitch_set, count_intervals_by_slots=True)
        ...
        c_pn_1 = nodes.NoteBehavior(name='stay put - c', direction=0, interval_weights=[(0, 1)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_2 = nodes.NoteBehavior(name='step up - c', direction=1, interval_weights=[(1, 4), (2, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_3 = nodes.NoteBehavior(name='step down - c', direction=-1, interval_weights=[(1, 4), (2, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_4 = nodes.NoteBehavior(name='skip up - c', direction=1, interval_weights=[(3, 5), (6, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_5 = nodes.NoteBehavior(name='skip down - c', direction=-1, interval_weights=[(3, 5), (6, 4)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_6 = nodes.NoteBehavior(name='leap up - c', direction=1, interval_weights=[(7, 6), (20, 1)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
        c_pn_7 = nodes.NoteBehavior(name='leap down - c', direction=-1, interval_weights=[(7, 6), (20, 1)],
                                                                 pitch_set=c_pitch_set, count_intervals_by_slots=False)
    ...
    def auto_add_dynamics(self):
        ...
        starting_dynamic = rand.weighted_rand(
        ...
        while current_index < note_array_length:
            ...
            # Find stop_index
            current_index += rand.weighted_rand(hairpin_length_weights, do_round=True)
    ...
    def auto_add_slurs(self):
        ...
        while 1 == 1:
            ...
            current_index += rand.weighted_rand(slur_gap_weights, do_round=True)
            ...
            ideal_stop_index = current_index + rand.weighted_rand(slur_length_weights, do_round=True)
    ...
    def change_mode(self, mode_change_frequency=True, note_count_weights=True, natural_harmonic_frequency=True,
        ...
        if artificial_harmonic_frequency:
            self.artificial_harmonic_frequency = round(
                rand.weighted_rand([(0.01, 150), (0.2, 20), (0.4, 5), (0.5, 1)]), 3)
        if chord_frequency:
            self.chord_frequency = round(
                rand.weighted_rand([(0.01, 150), (0.1, 20), (0.2, 0)]), 3)
        if length_network:
    ...
    def special_action_2(self):
        ...
        return text_instructions.draw_boxed_text(draw_text[0], draw_text[1])
    ...
    def special_action_3(self):
        ...
        :return:
        """
        return text_instructions.draw_big_fermata([(15, 1), (30, 8), (50, 2), (100, 0)])
