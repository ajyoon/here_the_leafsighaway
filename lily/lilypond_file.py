...
from lily import score, note
from shared import Globals
from image_tools import trimmer
...
class LilypondFile:
    ...
    def save_file(self, target_ly_file):
        ...
        if not self._string_built:
            self.create_string()
        output_path = os.path.join(Globals.ResourcesFolder, 'temp', 'lily', target_ly_file)
    ...
    def render_file(path):
        ...
        subprocess.call(["lilypond", "--png", "-dresolution=" + str(Globals.ImageDPI), path],
