...
class Application(tkinter.Frame):
    ...
    def build_directory_field(self):
        ...
        directory_path = tkinter.StringVar(self, Globals.PartOutputFolder, 'directory variable')
        ...
        def directory_button_action():
            ...
            if new_dir != '':
                ...
                Globals.PartOutputFolder = os.path.abspath(new_dir)
    ...
    def go_button_action(self):
        ...
        import top.part_maker
        Globals.PartOutputFolder = os.path.join(Globals.PartOutputFolder,
                                                str(random.randint(0, 10000)))
        if not os.path.exists(Globals.PartOutputFolder):
            os.makedirs(Globals.PartOutputFolder)
        print("Launching the part engine! Hold on to your hats!")
        # Call part_maker and make the parts!
        top.part_maker.make_parts(part_list, target_page_count=approx_page_count_per_part)

        tkinter.messagebox.showinfo('All done!', "Looks like everything went well, woohoo! "
                                    "Your new parts are located in:\n" +
                                    Globals.PartOutputFolder)
        self.master.quit()
