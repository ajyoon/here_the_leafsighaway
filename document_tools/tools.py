...
def part_attach_notes(input_pdf, part_name, open_when_finished=False):
    ...
    part_notes_folder = os.path.join(shared.Globals.ResourcesFolder, 'Part Notes')
    output_path = shared.Globals.PartOutputFolder
...
def register_font(font_name='Crimson Text'):
    ...
    font_folder = os.path.join(shared.Globals.ResourcesFolder, 'fonts')
